  ...
  <section class="bg-[#F4F7FF] h-screen py-10 lg:py-[40px]">
    <div v-if="!loading && profile" class="container mx-auto">
      <div class="flex flex-wrap">
        <div
          class="relative mx-auto w-3/6 max-w-[725px] overflow-hidden rounded-lg bg-white py-16 px-10 text-center sm:px-12 md:px-[60px]"
        >
          <form @submit.prevent="handleProfile">
            ...
            <div class="mb-6 border">
              <QuillEditor
                contentType="html"
                v-model:content="profile.introduction"
                readOnly="true"
                toolbar="#my-toolbar"
              >
                <template #toolbar>
